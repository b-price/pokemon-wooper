...
SlowpokeWellName:      rawchar "Wooper¯Well@"
...
PokemonLeagueName:     rawchar "Wooper¯League Gate@"
...
PokemonMansionName:    rawchar "Wooper¯Mansion@"
...
DiglettsCaveName:      rawchar "Wooper's¯Cave@"
...
CinnabarLabName:       rawchar "Wooper¯Lab@"
